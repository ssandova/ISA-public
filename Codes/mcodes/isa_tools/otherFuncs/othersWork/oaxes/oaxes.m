...
%     'HideParentAxes' property.  If the parent axes' 'Color' property is
%     different than the parent figure's 'Color' property, OAXES will use
%     the 'color' method regardless of the value of HideParentAxesMode.
%
...
% OpenGL renderer is used and any of the axes are set to 'log' scale, the
...
% v 2.4 : 2012-Aug-06
%       - Fixed bug when parent axes and figure have different background
%       colors
%       - Fixed error when deleting an oaxes with 'HideParentAxesMode' set
%       to 'color'
%       - Fixed bug preventing refresh when tick label text properties are
%       changed
%       - Fixed missing support for tick label text interpreter property
